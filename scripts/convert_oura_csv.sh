...
# Source: ${HOME}/data/data_lake/oura/csv_export/App Data/
# Target: ${HOME}/data/data_lake/oura/csv_raw/{endpoint}/
#
...
SOURCE_DIR="${HOME}/data/data_lake/oura/csv_export/App Data"
TARGET_BASE="${HOME}/data/data_lake/oura/csv_raw"
