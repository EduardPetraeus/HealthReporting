"""
Tracks the last successfully fetched date per Strava endpoint.
Persisted to ~/.config/health_reporting/strava_state.json between runs.
"""
...
logger = get_logger("strava.state")

STATE_FILE = Path.home() / ".config" / "health_reporting" / "strava_state.json"
