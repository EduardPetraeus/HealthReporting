...
-- Materialization: CREATE TABLE (rebuild when new lab tests arrive)
-- Source: DISTINCT marker metadata from silver.lab_results
--
-- Output columns:
--   sk_lab_marker        INTEGER  — surrogate key
--   marker_name          VARCHAR  — raw marker name from silver
--   marker_display_name  VARCHAR  — human-friendly name
--   marker_category      VARCHAR  — category from lab results
