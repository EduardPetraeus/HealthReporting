...
-- Materialization: CREATE TABLE (rebuild when supplement log changes)
-- Source: DISTINCT supplement metadata from silver.supplement_log
--
-- Output columns:
--   sk_supplement      INTEGER  — surrogate key
--   supplement_name    VARCHAR  — raw supplement name
--   category           VARCHAR  — vitamin/mineral/fatty_acid/probiotic/enzyme/amino_acid/other
--   dose               DOUBLE   — standard dose
--   unit               VARCHAR  — dose unit
--   target_condition   VARCHAR  — target health goal
-- =============================================================================
