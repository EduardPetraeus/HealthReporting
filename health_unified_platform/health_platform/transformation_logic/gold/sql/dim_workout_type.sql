...
-- Materialization: CREATE TABLE (rebuild when new activities appear)
-- Source: DISTINCT activity values from silver.workout
--
-- Output columns:
--   sk_workout_type        INTEGER  — surrogate key
--   activity_raw           VARCHAR  — raw activity string from silver
--   activity_name          VARCHAR  — cleaned display name
--   activity_category      VARCHAR  — cardio/strength/flexibility/mixed/recovery
--   is_cardio              BOOLEAN  — true if primarily cardiovascular
--   is_outdoor             BOOLEAN  — true if typically done outdoors
--   estimated_energy_system VARCHAR — aerobic/anaerobic/mixed
-- =============================================================================
