-- =============================================================================
-- mindful_session.sql
-- Silver: Apple Health mindful/meditation sessions
--
-- Source: health_dw.bronze.stg_apple_health_mindful_session
--
...
CREATE TABLE IF NOT EXISTS health_dw.silver.mindful_session (
...
CREATE OR REPLACE TABLE health_dw.silver.mindful_session_staging AS
WITH deduped AS (
    SELECT
        *,
        ROW_NUMBER() OVER (
    ...
    FROM health_dw.bronze.stg_apple_health_mindful_session
...
MERGE INTO health_dw.silver.mindful_session AS target
USING health_dw.silver.mindful_session_staging AS source
...
DROP TABLE IF EXISTS health_dw.silver.mindful_session_staging;
